...
<title>BlockShelf Library</title>
...
<main class="main">
  <section class="hero">
    <h1 class="hero-title">Welcome to BlockShelf</h1>
    <p class="hero-subtitle">A Modern digital library management system.</p>
  </section>
