...
Copy-Item $source $dest -Recurse -Exclude @(".git", "deploy-to-xampp.ps1")
Write-Host "Copied to $dest" -ForegroundColor Green
Write-Host ""
Write-Host "Next steps:"
Write-Host "  1. Open XAMPP Control Panel"
Write-Host "  2. Start Apache and MySQL"
Write-Host "  3. Open http://localhost/lirary/install.php"
Write-Host "  4. Then open http://localhost/lirary/"
